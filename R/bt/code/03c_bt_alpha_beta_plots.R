...
# save without map
# ggsave('Fig5_noMap.pdf', width = 350, height = 150, units = 'mm')
...
# ggsave('alpha_beta_taxaAllPoints_Concept_trans.png', width = 350, height = 350, units = 'mm')

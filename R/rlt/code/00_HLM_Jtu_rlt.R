...
Jtu_norm_RCTSRfyID <- brm(bf(Jtu_base ~ cYEAR + (cYEAR|rlm_clm_txa/STUDY_ID/rarefyID), 
	family = brmsfamily('gaussian')),	#, zero_one_inflated_beta()),
...
save(Jtu_norm_RCTSRfyID, file=Sys.getenv('OFILE'))
